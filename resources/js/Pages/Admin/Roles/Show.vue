    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center justify-between">
                ...
                <Link :href="`/internal/roles/${role.id}/rights`"
        ...
        <div class="max-w-2xl space-y-6">
            ...
            <div class="bg-white border border-warm-200 rounded-2xl overflow-hidden shadow-sm">
                ...
                <div v-if="!role.rights?.length" class="px-6 py-8 text-center text-sm text-warm-400">
                    ...
                    <Link :href="`/internal/roles/${role.id}/rights`" class="text-brand-600 hover:text-brand-800 font-medium ml-1">Add some →</Link>
                </div>
