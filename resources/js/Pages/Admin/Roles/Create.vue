...
function submit() {
    router.post('/internal/roles', form);
}
</script>
            ...
            <div class="bg-white border border-warm-200 rounded-2xl p-7 shadow-sm">
                <form @submit.prevent="submit" class="space-y-5">
                    <div>
                        ...
                        <input v-model="form.name" id="name" type="text" required placeholder="e.g. Editor"
                    ...
                    <div class="flex items-center gap-3 pt-2">
                        <button type="submit"
                                class="px-6 py-2.5 bg-brand-600 text-white text-sm font-semibold rounded-xl hover:bg-brand-700 transition-colors shadow-sm">
                            Create role
                        </button>
                        <Link href="/internal/roles"
