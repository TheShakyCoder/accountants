...
<template>
    <Head title="Dashboard — Acme Accountants Admin" />
            ...
            <div class="space-y-5">
                ...
                <div class="bg-gradient-to-br from-brand-500 to-brand-600 rounded-2xl p-5 text-white">
                    <div class="flex items-center gap-3 mb-4">
                        <img src="/media/logo.png" alt="Acme Accountants" class="h-12 w-auto brightness-0 invert opacity-90" />
                        <div>
                            <p class="font-semibold text-sm font-display">Acme Accountants</p>
                        </div>
                    </div>
